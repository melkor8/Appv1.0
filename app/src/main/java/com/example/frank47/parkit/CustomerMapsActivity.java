    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference dbcheck = FirebaseDatabase.getInstance().getReference().child("parkingspaces");
                dbcheck.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            ...
                            Toast.makeText(CustomerMapsActivity.this, "No parking spaces available at present", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                        System.out.println("afbnjfiagnfgn database error\n"+databaseError.getMessage());
                    }
                });
